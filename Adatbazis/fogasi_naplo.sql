...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2022. Ápr 14. 07:26
...
(5, 111111, 2, NULL, '2021-11-30 09:30:00', 'amur', 3.5),
...
(14, 774234, 1, NULL, '2021-09-21 08:46:00', 'harcsa', 1.5),
...
(30, 444444, 12, NULL, '2021-09-21 14:51:00', 'amur', 3),
...
(36, 222222, 9, NULL, '2021-09-21 14:48:00', 'csuka', 2),
...
(41, 111111, 1, '4', '2021-08-30 12:30:00', 'amur', 1),
...
(67, 111111, 2, 'Nincs', '2022-03-28 20:21:00', 'garda', 5);
...
(3, 'Tisza folyó Csongrád megyei', 600311),
(4, 'Maros folyó', 600411),
(5, 'Hármas-Körös folyó', 600511),
(6, 'Csongrádi vízlépcső', 600611),
(7, 'Gyálai Holt-Tisza (0-12+874 fkm.)', 600711),
...
ALTER TABLE `fogasok`
  ...
  ADD UNIQUE KEY `datum_idopont` (`datum_idopont`,`azonosito`,`halfaj`,`suly`) USING BTREE,
  ADD KEY `fogasok_ibfk_1` (`azonosito`),
  ADD KEY `fogasok_ibfk_2` (`helyszinID`);
...
--
ALTER TABLE `helyszinek`
  MODIFY `helyszinID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT a táblához `szerepkorok`
--
ALTER TABLE `szerepkorok`
  MODIFY `szerepkorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `fogasok`
  ADD CONSTRAINT `fogasok_ibfk_1` FOREIGN KEY (`azonosito`) REFERENCES `felhasznalok` (`azonosito`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fogasok_ibfk_2` FOREIGN KEY (`helyszinID`) REFERENCES `helyszinek` (`helyszinID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
